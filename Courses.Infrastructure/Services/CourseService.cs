...
using Courses.Infrastructure.Factories;
...
public class CourseService(IDbContextFactory<DataContext> dbContextFactory) : ICourseService
{
    ...
    public async Task<Course> UpdateCourseAsync(CourseUpdateRequest request)
    {
        ...
        await context.SaveChangesAsync();
        return CourseFactory.Create(updatedCourseEntity);
    }
}
